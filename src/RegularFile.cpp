...
Binary_File::Binary_File(std::filesystem::path path): File(path, std::filesystem::file_size(path)){}
...
Text_File::Text_File(std::filesystem::path path): File(path, std::filesystem::file_size(path)){
...
//-----------------------------------------------------------------
Image_File::Image_File(std::filesystem::path path): File(path, std::filesystem::file_size(path)), width(0), height(0), bit_depth(0){}
